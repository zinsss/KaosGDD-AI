...
class WebTaskValidationTests(unittest.TestCase):
    ...
    def test_official_web_prompts_support_treatment_options(self) -> None:
        ...
        self.assertIn("www.cdc.gov", KAOSAI_OFFICIAL_WEB_PLAN_SYSTEM_PROMPT)
        self.assertIn("www.nice.org.uk", KAOSAI_OFFICIAL_WEB_PLAN_SYSTEM_PROMPT)
        self.assertIn("jcsm.aasm.org", KAOSAI_OFFICIAL_WEB_PLAN_SYSTEM_PROMPT)
