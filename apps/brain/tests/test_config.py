...
class SettingsTests(unittest.TestCase):
    def test_parses_minimal_configuration(self) -> None:
        ...
        self.assertFalse(settings.respond_without_mention)
        ...
        self.assertFalse(settings.active_control_enabled)
        self.assertEqual(settings.active_control_repost_seconds, 0)
