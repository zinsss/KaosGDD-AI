...
VERSE_ROTATION = (
    ...
    ("요한복음 3:16", "하나님의 사랑과 생명의 약속을 믿으며 오늘을 살아가세요."),
    ("시편 121:1-2", "도움은 세상을 지으신 하나님에게서 옵니다."),
    ("로마서 12:2", "세상의 흐름에 머물지 말고 마음을 새롭게 하여 좋은 길을 분별하세요."),
    ("고린도전서 13:4-7", "사랑은 오래 참고 친절하며 끝까지 믿고 바라고 견딥니다."),
    ("시편 37:5", "오늘의 길을 하나님께 맡기고 신뢰하세요."),
    ("이사야 40:31", "하나님을 바라보는 사람은 새 힘을 얻어 다시 걸어갈 수 있습니다."),
    ("마태복음 6:33", "먼저 하나님의 뜻과 바른 길을 구하면 필요한 것을 채워 주십니다."),
    ("시편 119:105", "하나님의 말씀은 오늘 걸어갈 길을 비추는 등불입니다."),
    ("빌립보서 4:6-7", "염려를 기도로 맡기면 이해를 넘어서는 평안이 마음을 지켜 줍니다."),
    ("디모데후서 1:7", "하나님은 두려움이 아니라 능력과 사랑과 절제의 마음을 주십니다."),
    ("시편 34:8", "하나님의 선하심을 직접 경험하고 그 안에서 피난처를 찾으세요."),
    ("잠언 16:9", "사람이 길을 계획해도 걸음을 이끄시는 분은 하나님입니다."),
    ("예레미야애가 3:22-23", "하나님의 사랑과 긍휼은 다함이 없고 아침마다 새롭습니다."),
    ("로마서 12:12", "소망 가운데 기뻐하고 어려움 중에 견디며 기도를 이어 가세요."),
    ("히브리서 11:1", "믿음은 바라는 것을 붙들고 보이지 않는 것을 확신하는 힘입니다."),
    ("시편 139:14", "당신은 놀랍고 귀하게 지음 받은 존재임을 기억하세요."),
)
...
class DailyDigestService:
    def __init__(self, config: DailyDigestConfig, adapter: CalendarAdapterClient) -> None:
        ...
        self.content = DailyContentLibrary(
            ...
            preferred_bible_references=tuple(reference for reference, _text in VERSE_ROTATION),
            shuffle_daily=True,
        )
