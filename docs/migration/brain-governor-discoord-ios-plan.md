...
| 2026-09-01 | 6 | Kept only Memos tags rounded in the embedded web client | Added a tracked `kaosgdd-memos-web:0.1.6-rectangular-controls` image layer that squares Memos search/editor/action controls while explicitly preserving rounded tag chips | Presentation-only follow-up; Memos web image promotion pending |
