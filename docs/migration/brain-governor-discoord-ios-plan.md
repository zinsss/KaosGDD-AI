...
| 2026-08-31 | 6 | Rebalanced the personal compact header with the flat page selector on the left and a larger `KaosGDD` wordmark on the right | CSS-only profile-scoped layout; focused portal tests and deployed-asset comparison required before promotion | Presentation-only follow-up; Family header, routes, APIs, and data remain unchanged |
