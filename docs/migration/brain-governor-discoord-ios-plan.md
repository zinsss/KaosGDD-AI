...
| 2026-09-01 | 6 | Normalized personal Tasks and Memos action button heights | Tasks Add no longer stretches to the label row; embedded Memos search and `+` controls share a compact 44 px height while tag chips stay rounded; versioned `styles.css?v=252` | Presentation-only follow-up; promotion pending |
