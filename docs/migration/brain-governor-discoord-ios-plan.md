...
| 2026-08-31 | 6 | Rebalanced the personal compact header with the flat page selector on the left and a larger `KaosGDD` wordmark on the right | Commit `6208dab`; 11 focused portal tests passed; deployed HTML/CSS hashes match repository sources; H4 synced and doctor healthy | Presentation-only follow-up; Family header, routes, APIs, data, and Brain runtime remain unchanged |
