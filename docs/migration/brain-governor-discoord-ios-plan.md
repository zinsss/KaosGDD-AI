...
| 2026-09-01 | 6 | Moved Tasks Add into the collection selector row | Tasks now renders `All / Family / GDDZiN / Add`, with Add as a highlighted rectangular collection-row action; the lower filter row is only Tasks and Order; versioned `styles.css?v=255` and `app.js?v=239` | Presentation-only follow-up; promotion pending |
