...
| 2026-09-01 | 6 | Made the shell quick-add button circular | Top-right `+` is now the only rounded control exception in the main shell while the rest of the PWA controls stay rectangular; versioned `styles.css?v=260` | Presentation-only follow-up; promotion pending |
