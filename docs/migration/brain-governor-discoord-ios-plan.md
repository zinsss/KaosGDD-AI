...
| 2026-09-01 | 6 | Removed redundant Supplies content header | Full Supplies page no longer renders the in-panel `Supplies / Buy list / Utils` header; the top PWA title remains the only page header; versioned `app.js?v=242` | Presentation-only follow-up; promotion pending |
