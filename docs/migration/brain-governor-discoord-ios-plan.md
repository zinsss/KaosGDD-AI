...
| 2026-09-01 | 6 | Simplified archive rows to number, date, and one-line title | Documents and Fax archive boards now omit list-row correspondent/status fields and render title as one-line ellipsis; detail panels retain metadata; versioned `styles.css?v=258` and `app.js?v=241` | Presentation-only follow-up; promotion pending |
