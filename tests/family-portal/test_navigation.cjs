...
test("the navigation contract loads before the portal application", () => {
  ...
  const styleIndex = index.indexOf('href="/styles.css?v=390"');
  ...
  const applicationIndex = index.indexOf('src="/app.js?v=372"');
...
test("calendar month panel rendering is delegated to the view module", () => {
  ...
  assert.ok(index.indexOf('src="/calendar-view.js?v=2"') < index.indexOf('src="/app.js?v=372"'));
