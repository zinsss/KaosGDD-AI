...
test("the navigation contract loads before the portal application", () => {
  ...
  const styleIndex = index.indexOf('href="/styles.css?v=339"');
  ...
  const applicationIndex = index.indexOf('src="/app.js?v=341"');
...
test("calendar month panel rendering is delegated to the view module", () => {
  ...
  assert.ok(index.indexOf('src="/calendar-view.js?v=1"') < index.indexOf('src="/app.js?v=341"'));
});
