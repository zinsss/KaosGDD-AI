...
test("memos archive rendering is delegated to the view module", () => {
  ...
  assert.ok(indexSource.indexOf('src="/memos-view.js?v=11"') < indexSource.indexOf('src="/app.js?v=392"'));
});
...
test("documents archive rendering is delegated to the view module", () => {
  ...
  assert.ok(indexSource.indexOf('src="/documents-view.js?v=2"') < indexSource.indexOf('src="/app.js?v=392"'));
});
