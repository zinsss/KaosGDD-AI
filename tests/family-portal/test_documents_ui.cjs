...
test("memos archive rendering is delegated to the view module", () => {
  ...
  assert.ok(indexSource.indexOf('src="/memos-view.js?v=3"') < indexSource.indexOf('src="/app.js?v=353"'));
});
...
test("documents archive rendering is delegated to the view module", () => {
  ...
  assert.ok(indexSource.indexOf('src="/documents-view.js?v=1"') < indexSource.indexOf('src="/app.js?v=353"'));
});
