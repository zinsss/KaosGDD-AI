...
`$KAOS_ROOT/retired-secrets/h3-governor-discord/discord_bot_token`. The
directory is mode 0700, the token mode is preserved, repeated runs are
idempotent, and a source/destination collision fails closed. External Discord
application revocation remains a manual account-side step.
